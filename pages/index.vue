...
const getPoemWithAttribution = () => {
  if (!poem.value) return '';
  const attribution = locale.value === 'nl'
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            >
              <div class="flex items-center justify-center gap-2">
                ...
                <p class="text-sm font-bold text-green-800 font-cinzel">
        ...
        >
          ...
          <div class="mb-6 border-b-2 border-red-100 pb-4">
            <h2 class="text-3xl font-bold text-red-900 font-cinzel w-full mb-3">
              {{ poemTitle }}
            </h2>
            <div v-if="poem" class="flex gap-2 flex-wrap w-full">
              ...
              <UButton
                ...
                data-umami-event="Share via WhatsApp"
              >
                <template #leading>
              ...
              <UButton
                ...
                class="border-red-300 hover:bg-red-50 text-red-700 cursor-pointer"
                @click="shareViaEmail"
                data-umami-event="Share via Email"
              >
                {{ t('poem.shareEmail') }}
              </UButton>
            </div>
